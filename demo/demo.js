...
var cbanc$snackbar$Demo$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Snackage':
				var _n1 = A2(cbanc$snackbar$Snackbar$message, cbanc$snackbar$Demo$sbDelay, 'Message only snackbars are used to notify someone. They should make themselves disappear');
				var sb = _n1.a;
				var cmd = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Snacklink':
				var _n2 = A4(cbanc$snackbar$Snackbar$link, cbanc$snackbar$Demo$sbDelay, 'Href snackbars show a button which navigates to a new address', 'DOGS', 'http://omfgdogs.com');
				var sb = _n2.a;
				var cmd = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
...
_Platform_export({'Demo':{'init':cbanc$snackbar$Demo$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Demo.Msg","aliases":{},"unions":{"Demo.Msg":{"args":[],"tags":{"Snackage":[],"Snacklink":[],"Snaction1":[],"Snaction2":[],"SnackMessage":["Snackbar.Msg"]}},"Snackbar.Msg":{"args":[],"tags":{"ButtonClick":["String.String"],"EndDelay":["Basics.Int"],"StartDelay":["Basics.Float","Time.Posix"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});}(this));