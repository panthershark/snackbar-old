...
var cbanc$snackbar$Snackbar$CustomDelay = function (a) {
	return {$: 'CustomDelay', a: a};
};
var cbanc$snackbar$Snackbar$DefaultDelay = {$: 'DefaultDelay'};
var cbanc$snackbar$Snackbar$ShowForever = {$: 'ShowForever'};
...
var cbanc$snackbar$Snackbar$delayCmd = function (ms) {
	return A2(
		elm$core$Task$perform,
		...
		return _Utils_Tuple2(
			...
			function () {
				switch (delay.$) {
					...
					case 'DefaultDelay':
						return cbanc$snackbar$Snackbar$delayCmd(10000);
					default:
						var ms = delay.a;
						return cbanc$snackbar$Snackbar$delayCmd(ms);
				}
			}());
	});
			...
			function () {
				switch (delay.$) {
					case 'ShowForever':
						return elm$core$Platform$Cmd$none;
					case 'DefaultDelay':
						return cbanc$snackbar$Snackbar$delayCmd(4000);
					default:
						var ms = delay.a;
						return cbanc$snackbar$Snackbar$delayCmd(ms);
				}
...
var cbanc$snackbar$Demo$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Snackage':
				var _n1 = A2(cbanc$snackbar$Snackbar$message, cbanc$snackbar$Snackbar$DefaultDelay, 'Snackbars should make themselves disappear. This one has a default 4 second delay.');
				var sb = _n1.a;
				var cmd = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Snacklink':
				var _n2 = A4(
					cbanc$snackbar$Snackbar$link,
					cbanc$snackbar$Snackbar$CustomDelay(6000),
					'Link snackbars show a button which navigates to a new address',
					'DOGS',
					'http://omfgdogs.com');
				var sb = _n2.a;
				var cmd = _n2.b;
			...
			case 'Snaction1':
				var _n3 = A4(
					cbanc$snackbar$Snackbar$action,
					cbanc$snackbar$Snackbar$ShowForever,
					'Action snackbars allow update to process Msgs. This one will stay open until you click the action.',
					'CLOSE',
					cbanc$snackbar$Demo$EchoAction('CLOSE'));
				var sb = _n3.a;
				var cmd = _n3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Snaction2':
				var _n4 = A4(
					cbanc$snackbar$Snackbar$action,
					cbanc$snackbar$Snackbar$DefaultDelay,
					'Action snackbars allow update to process Msgs. They send a key to the update fn so you can tell which action was trigger.',
					'YO!',
			...
			case 'EchoAction':
				var str = msg.a;
				return (str === 'CLOSE') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							alert: elm$core$Maybe$Just(str + ' was clicked'),
							snackbar: cbanc$snackbar$Snackbar$hidden
						}),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Snack Message')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Snack Action 1')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Snack Action 2')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
