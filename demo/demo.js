...
_Platform_export({'Demo':{'init':cbanc$snackbar$Demo$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Demo.Msg","aliases":{},"unions":{"Demo.Msg":{"args":[],"tags":{"UpdateSnackbar":["Snackbar.Model"],"SnackMessage":["Snackbar.Msg"]}},"Snackbar.Model":{"args":[],"tags":{"None":[],"Message":["String.String"],"Href":["String.String","String.String","String.String"],"Action":["String.String","String.String","String.String"]}},"Snackbar.Msg":{"args":[],"tags":{"ButtonClick":["String.String"],"Hide":["Snackbar.Model"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));